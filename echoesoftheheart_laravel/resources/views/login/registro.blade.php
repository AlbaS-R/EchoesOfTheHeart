            ...
            <form action="{{ route('processRegister') }}" method="POST">
                ...
                <button id="btnSend" type="submit" style="border: none; background: none; position: relative;">
                    <div class="buttons-container"style="border: none; background: none; position: relative;">
                        ...
                        <span
                            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: rgb(201, 82, 13); font-weight: bold; font-size: 16px; font-family:GreekFont;">Resgistrar</span>
                    </div>
                </button>
                <div class="error">
                    @if ($errors->any())
